...
namespace AutomatedUITesting.Web.Test.UI.Features
{
    ...
    public partial class CounterShouldBePropertyIncrementingItsValueFeature : object, Xunit.IClassFixture<CounterShouldBePropertyIncrementingItsValueFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public CounterShouldBePropertyIncrementingItsValueFeature(CounterShouldBePropertyIncrementingItsValueFeature.FixtureData fixtureData, AutomatedUITesting_Web_Test_UI_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Counter should be property incrementing its value", null, ProgrammingLanguage.CSharp, new string[] {
                        "Counter"});
        ...
        [Xunit.TraitAttribute("FeatureTitle", "Counter should be property incrementing its value")]
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 5
 testRunner.Given("a user in then counter page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 6
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                CounterShouldBePropertyIncrementingItsValueFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                CounterShouldBePropertyIncrementingItsValueFeature.FeatureTearDown();
            }
        }
    }
}
